    ...
    imagen: "https://images.unsplash.com/photo-1526481280693-3bfa7568e0f3?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1171&q=80"},
{
    ...
    texto: "Este es un recorrido de 10 días por la región Tohoku, al noreste de Japón. Experimenta los caminos poco conocidos, la cocina regional, los lugares históricos y quédate en hospederías tradicionales.",
...
},
{
    ...
    texto:"Visita el templo más importante del distrito de Arashiyama.Su atracción principal es el jardín Zen, un jardín con estanque donde se capta el reflejo de los arces y las rocas en la periferia.",
...
},
{
    ...
    texto:"Descubre los secretos de su historia y arquitectura de manera amena y entretenida. Si reservas esta excursión también visitarás el parque de Nara, famoso por sus ciervos Sika.",
